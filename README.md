# 🚀 Media - The Ultimate Module for Laravel
...
1. **Install** via Composer: `composer require vendor/Media`
2. **Publish** assets: `php artisan vendor:publish --provider="Vendor\\Media\\ServiceProvider"`
3. **Enjoy**! 🎉
