...
\`\`\`bash
qmd search "<topic>" -c media
# Cerca solo in ./laravel/Modules/Media/docs/wiki/
\`\`\`
...
\`\`\`bash
qmd search "form" -c media  # Solo questo modulo
\`\`\`
...
| Ricerca lenta | Limita con `-c media` |
