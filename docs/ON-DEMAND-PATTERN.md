...
# On-Demand Pattern — Module **Media**
...
| Ricerca locale | `qmd search "topic" -c media` |
| Wiki locale | `Read ./laravel/Modules/Media/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Modules/Media/docs/wiki/log.md
