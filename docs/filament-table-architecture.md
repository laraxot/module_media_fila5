...
module: Media
updated: 2026-09-01
qmd: "tabella filament resource table class getTableFilters XotBaseResourceTable HasXotTable list page media"
---
...
```php
namespace Modules\Media\Filament\Resources\FooResource\Tables;
