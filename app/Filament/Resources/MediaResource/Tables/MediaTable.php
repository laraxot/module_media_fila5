...
class MediaTable extends XotBaseResourceTable
{
    ...
    public function getTableColumns(): array
    {
        return [
            ...
            'disk' => TextColumn::make('disk')->sortable()->toggleable(isToggledHiddenByDefault: true),
            'size' => TextColumn::make('size')->numeric()->suffix(' B')->sortable(),
            'order_column' => TextColumn::make('order_column')->sortable()->toggleable(isToggledHiddenByDefault: true),
            'model_type' => TextColumn::make('model_type')->searchable()->sortable()->toggleable(isToggledHiddenByDefault: true),
            'model_id' => TextColumn::make('model_id')->searchable()->sortable()->toggleable(isToggledHiddenByDefault: true),
